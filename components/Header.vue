<template>
  <header class="flex justify-between gap-2 p-2 px-[5%] lg:px-[11.45%]  border-b h-[80px] items-center fixed top-0 left-0 w-full">
    <div class="flex gap-[30px] items-center">
      ...
      <nav class="w-[24.13%]">
        <ul class="flex gap-[7.84%] w-[full] min-w-[340px]">
          <li class="flex items-center gap-[4px] font-[500] text-[14px] leading-[20px]">
            <nuxt-link class="" to="">Products 
            </nuxt-link>
